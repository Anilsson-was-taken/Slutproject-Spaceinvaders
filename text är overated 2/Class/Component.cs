...
namespace text_är_overated_2
{
    public class Component : ICloneable
    {
        ...
        //4 och 5 då den är 0.20f i drwa funktion. 4 eftersom 5 var inkonistent. Den anänvder klassens texture och position och skaper en individuel rectangle
        ...
        public Rectangle Rectangle
        {
            get
            {
                return new Rectangle((int)Position.X, (int)Position.Y, BaseTexture.Width/4, BaseTexture.Height/5);
            }
        }
